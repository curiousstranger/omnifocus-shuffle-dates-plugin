...
(() => {
  ...
  const shuffleDatesLib = {};
  
  // Library metadata
  shuffleDatesLib.version = "1.0";
  shuffleDatesLib.author = "George Mandis, Matt Cable";
  shuffleDatesLib.identifier = "org.curiousstranger.ShuffleDatesLibrary";
